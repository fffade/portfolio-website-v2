    ...
    <React.Fragment>
      <div className="container-fluid flex flex-col items-center justify-start h-5/6 gap-y-8 p-24">
        ...
        <div className="container w-1/3">
          ...
          <p className="text-xl text-white p-2">I had a passion for computer science as a young child. I would spend all my free time watching YouTube and studying various programming languages. I learnt to build my own websites and even learnt how to construct
