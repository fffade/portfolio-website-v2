...
function SubmitButton() {
  return (
    <button type="submit" className="w-1/3 p-4 m-8 rounded-full self-center bg-slate-700 text-2xl text-white font-bold transition-all hover:scale-105 hover:text-gray-300">SUBMIT</button>
  );
}
